        ...
        <tr>
            <td class="sidebar" width="30%">
                <div class="profile-section">
                    <#if imageData??>
                        <div class="profile-image-container" style="background-image: url('${imageData}');"></div>
                    </#if>
                </div>
                                ...
                                <tr>
                                    <td style="width: 12px; vertical-align: top; padding-right: 10px;">
                                        <span class="timeline-dot"
                                            style="display: inline-block; width: 12px; height: 12px; background-color: #1E3A8A; border-radius: 50%;"></span>
                                    </td>
                                    <td>
